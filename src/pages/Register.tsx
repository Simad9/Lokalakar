...
const Register = () => {
  ...
  return (
    <AuthLayout
      ...
      subtitle="Buat akun untuk mengakases LOKALAKAR dan menikmati fitur menyenangkan"
      leftContent={{
        title: "Pengalaman baru",
        description: "Jelajahi UMKM Makanan dengan pengalaman baru dan asik",
      }}
    >
